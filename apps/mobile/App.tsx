...
const styles = StyleSheet.create({
  ...
  pageActionRailCompact: { width: "100%", flexDirection: "row", alignItems: "center", gap: 6, flexShrink: 0 },
  pageActionButton: {
    minWidth: 96,
    minHeight: 42,
    flexDirection: "row",
  ...
  pageActionButtonCompactSide: { backgroundColor: palette.panel2 },
  pageActionButtonCompactPrimary: { flex: 1, minWidth: 0 },
  ...
  pageActionText: { color: palette.text, fontSize: 11, fontWeight: "900" },
