...
export const BatchSummarySchema = Type.Object({
  ...
  estimatedCostUsd: Type.Optional(Type.Union([Type.Number(), Type.Null()])),
  estimatedProviderCostUsd: Type.Optional(Type.Union([Type.Number(), Type.Null()])),
  confirmedCostUsd: Type.Optional(Type.Union([Type.Number(), Type.Null()])),
  confirmedPriceVersion: Type.Optional(Type.Union([Type.String(), Type.Null()])),
  confirmedCostBreakdown: Type.Optional(Type.Union([Type.Record(Type.String(), Type.Unknown()), Type.Null()])),
